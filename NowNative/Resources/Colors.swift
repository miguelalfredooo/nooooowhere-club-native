...
struct Colors {
  ...
  static let parchment = UIColor(red: 0.95, green: 0.93, blue: 0.89, alpha: 1.0)  // #F2EDE4
  static let iron = UIColor(red: 0.16, green: 0.15, blue: 0.13, alpha: 1.0)       // #2A2520
  static let dust = UIColor(red: 0.60, green: 0.56, blue: 0.51, alpha: 1.0)       // #9A8F82
